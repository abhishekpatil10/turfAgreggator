...
const Register = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#727af9]/20 to-pink-100/20 flex">
            {/* Left side illustration - Changed from w-1/2 to w-2/5 (40%) */}
            <div className="hidden md:flex w-2/5 bg-[#727af9] items-center justify-center p-8">
            ...
            {/* Right side content - Changed from w-1/2 to w-3/5 (60%) */}
